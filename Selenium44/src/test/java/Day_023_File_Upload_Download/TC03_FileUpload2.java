		...
		public void File_upload()throws Exception
		  {
			...
			//SendKeys
				...
				findElement(By.xpath("//button[@type='submit']")).click();
				 ...
				 findElement(By.xpath("//*[text()=' Add ']")).click();
				 
				 findElement(By.xpath("//div[text()='Browse']")).click();
			 	
					Thread.sleep(1000);
					//WebElement  BrowseButton=findElement(By.xpath("//div[@class='oxd-file-button']"));					
					
					//Actions actions = new Actions(driver);
				  	//actions.moveToElement(BrowseButton).click().perform();
			...
			findElement(By.xpath("//textarea[@placeholder='Type comment here']")).sendKeys("wewqeqweqweqwe");
			 	 
			findElement(By.xpath("(//button[text()=' Save '])[3]")).click();
