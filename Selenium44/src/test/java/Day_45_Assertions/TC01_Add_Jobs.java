  ...
  @Test
     ...
     public void Jobstest( ) throws Exception {
	   ...
	   driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(2));
		...
		s1.assertEquals(str, "Admins45345");
		
		
		if(str.equals("Admins45345"))
		{
		...
		driver.findElement(By.xpath("//*[@id='app']/div[1]/div[2]/div[2]/div/div/form/div[1]/div/div[2]/input")).sendKeys("Sales1350");
		driver.findElement(By.xpath("//*[@id='app']/div[1]/div[2]/div[2]/div/div/form/div[2]/div/div[2]/textarea")).sendKeys("Sales1350 Descr");
		driver.findElement(By.xpath("//*[@id='app']/div[1]/div[2]/div[2]/div/div/form/div[4]/div/div[2]/textarea")).sendKeys("Sales1350 Notes");
