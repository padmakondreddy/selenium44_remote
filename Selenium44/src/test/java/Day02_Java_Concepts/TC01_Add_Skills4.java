...
public class TC01_Add_Skills4 {
	...
	String SkillName="Java10",SkillDescr="Java10 descr";
  ...
  public void MainTest() throws Exception {
	  ...
	  TC01_Add_Skills4.OpenChrome();
	  TC01_Add_Skills4.OpenOrangeHRM(TestURL);//Step2
	  TC01_Add_Skills4.Login(UserName,PassWord);//Step2
	  TC01_Add_Skills4.AddSkills(SkillName,SkillDescr);//Step2
