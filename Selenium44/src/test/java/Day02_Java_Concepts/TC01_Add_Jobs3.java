...
public class TC01_Add_Jobs3 {
  ...
  public void JobsTest() {
	  ...
	  TC01_Add_Jobs3 T2=new TC01_Add_Jobs3();
		
	  T2.open_Chrome_Browser();  
	  T2.open_OrangeHRM(TestURL);      //step2 - We are passing global variables to appriopriate methods  
	  T2.Login(UserName,PassWord);   //step2 - We are passing global variables to appriopriate methods  
  ...
  public void open_OrangeHRM(String TestURL1)
  {
	  driver.get(TestURL1);
  }
  ...
  public void AddJobs(String JobTitle1,String JobDsscr1,String JobNote1)
  {
