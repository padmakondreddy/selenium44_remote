...
public class TC014_Startswith2 {
	...
	//String Nationality_xpath ="//*[starts-with(@id,'menu_admin_nationality')]";
		...
		String Google_Input_text="(//img[@alt='Google']//following::textarea)[1]";
	...
	public void Test1()throws Exception
	{
		...
		List<WebElement> Elements=driver.findElements(By.xpath("//span[text()='selenium']/b"));
